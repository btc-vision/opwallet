...
export const TOS_VERSION = process.env.tos ?? '0.0.1';
export const TOS_LAST_UPDATE = process.env.tosLastUpdate ?? '2025-12-20';

export const DOMAIN_TOS_VERSION = process.env.domainTosVersion ?? 'eea0.0.1';
export const DOMAIN_TOS_LAST_UPDATE = process.env.domainTosLastUpdate ?? 'eea2025-12-20';
