 ...
 * -------------------------------------------------------------------------*/
export function decodeSafeTransfer(selector: InteractionType, reader: BinaryReader): DecodedSafeTransfer {
...
export function decodeSafeTransferFrom(selector: InteractionType, reader: BinaryReader): DecodedSafeTransferFrom {
