...
export default function ImportTokenScreen() {
    ...
    const [suggestedTokens, setSuggestedTokens] = useState<Array<{address: string, name: string, symbol: string, logo?: string}>>([]);
        ...
        void (async () => {
            ...
            if (moto && !storedAddresses.includes(moto)) {
                try {
                    ...
                    suggestions.push({ address: moto, name: 'Pill', symbol: 'PILL' });
                }
            }
            if (pill && !storedAddresses.includes(pill)) {
                try {
                    ...
                    suggestions.push({ address: pill, name: 'Motoswap', symbol: 'MOTO' });
                }
            }
